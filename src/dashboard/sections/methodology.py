...
def render(filtered_df: pd.DataFrame, raw_df: pd.DataFrame, datamap_variables: pd.DataFrame, datamap_texts: pd.DataFrame) -> None:
    ...
    with tab1:
        ...
        st.dataframe(engineered, width='stretch')

    with tab2:
        st.markdown(
            '| Segment | Characteristics |\n'
            '|---|---|\n'
            '| **Premium Legal Users** | High-value, legal paid access, low risk score |\n'
            '| **Hybrid Monetizers** | High-value but still using illicit channels |\n'
            '| **Heavy Free Users** | Engaged, broad consumption, zero spending |\n'
            '| **Risk-Oriented Free Users** | High risk intensity, high illicit-method breadth |\n'
            '| **Casual Value Seekers** | Some spending but lower engagement depth |\n'
